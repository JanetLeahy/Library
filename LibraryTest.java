...
public class LibraryTest {
	...
	public void testAdd() {
		...
		lib.add(new Book("Title", "Author"), "Foothills");
	...
	public void testCheckout() {
		...
		lib.addBranch("Foothills");
		lib.add(new Book("Title", "Author"), "Foothills");
		lib.add(new Book("Title2", "Author"), "Foothills");
